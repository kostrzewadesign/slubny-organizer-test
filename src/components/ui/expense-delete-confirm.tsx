...
export function ExpenseDeleteConfirm({ isOpen, onClose, onConfirm, expenseTitle }: ExpenseDeleteConfirmProps) {
    ...
    <>
      ...
      >
        ...
        <div className="flex flex-col items-center text-center">
          ...
          >
            Wydatek "<span className="font-semibold">{expenseTitle}</span>" zostanie trwale usunięty. Tej operacji nie można cofnąć.
          </p>
