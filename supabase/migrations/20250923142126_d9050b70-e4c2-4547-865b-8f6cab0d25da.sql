-- Optymalizacja budżetu - funkcja podsumowania z poprawnymi wartościami enum
...
AS $$
  SELECT
    ...
    COALESCE(SUM(CASE WHEN payment_status = 'none' THEN amount ELSE 0 END), 0) as remaining,
