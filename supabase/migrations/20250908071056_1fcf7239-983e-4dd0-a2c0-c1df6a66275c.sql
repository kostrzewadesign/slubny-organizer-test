-- Fix the search_path security warnings for the newly created functions
-- All functions must have a proper search_path set for security

-- Recreate check_guest_operation_rate_limit with proper search_path
...
-- Recreate enhanced_sanitize_guest_data with proper search_path
